              ...
              <div className="about-scroll-container">
                <div className="about-scroll-panel">
                  <div className="scroll-panel-header">
                    <h2 className="scroll-panel-title">YOUR VISION, OUR YARN LIBRARY</h2>
                    {/* Always show chevron */}
                    <button
                  ...
                  <div className="scroll-panel-content no-image">
                    <div className="scroll-panel-text">
                      <p>
                        Swatches delivered in <strong>1-2 weeks</strong>, knit on industry-standard machinery and
                        tailored to your aesthetic.
                      </p>
                      <p>
                        <strong>Our in-house yarn library</strong> and global mill partnerships provide specialty
                        materials curated for quality, provenance, and performance.
                      </p>
                      <p>
                        <strong>Track progress</strong> in real time on our collaborative digital whiteboard, and skip
                        the guesswork. We turn your sketches into production ready knitwear.
                      </p>
                      <p>
                        <strong>Limitless experimentation</strong>, fast turnaround, and what you sample is what you
                        get.
                      </p>
                    </div>
                  </div>
